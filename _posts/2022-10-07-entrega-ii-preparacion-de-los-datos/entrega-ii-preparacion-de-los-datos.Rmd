...
Por último, se crea un archivo con los datos tratados para que puedan ser utilizados en los distintos modelos que se creen posteriormente.

```{r}
write.csv(dataKNN,
"C:\\Users\\iqp20\\OneDrive\\Documentos\\DatosPoliticos\\inesqp\\_posts\\2022-10-20-entrega-iii-modelos\\datos.csv",
row.names=FALSE)